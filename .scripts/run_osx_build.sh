...
validate_recipe_outputs "ldas-tools-frameapi-swig-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="ldas-tools-frameapi-swig-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi